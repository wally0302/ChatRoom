import 'package:test_project/helper/helper_function.dart';
import 'package:test_project/pages/auth/register_page.dart';
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          // check tha validation (檢查email格式是否正確)
                          validator: (val) {
                            return RegExp(
                        ...
                        TextFormField(
                          ...
                          // check tha validation (檢查密碼是否至少6個字元)
                          validator: (val) {
                            if (val!.length < 6) {
